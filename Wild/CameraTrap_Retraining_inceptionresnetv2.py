...
train_data_dir = "Korea_CameraTrapPhotos/training"
validation_data_dir = "Korea_CameraTrapPhotos/validation"

nb_train_samples = 1246
...
# i.e. freeze all Inception layers
...
FREEZE_LAYERS = len(model.layers) - 10 # train only last 10 layers
...
model_final.load_weights('TrainedWeights/InceptionResnetV2_Korea_retrain.h5')
...
with open('InceptionResnetV2_Korea_retrain_final_architecture.json', 'w') as f:
...
checkpoint = ModelCheckpoint("TrainedWeights/InceptionResnetV2_Korea_retrain.h5", monitor='acc', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
# Save the model
model_final.save('TrainedWeights/InceptionResnetV2_Korea_retrain_final.h5')
