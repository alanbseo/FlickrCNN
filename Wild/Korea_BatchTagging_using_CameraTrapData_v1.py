...
photo_path_base = '/Users/seo-b/Dropbox/KIT/FlickrEU/FlickrCNN/Korea_CameraTrapPhotos'
...
with open('InceptionResnetV2_Korea_retrain_final_architecture.json', 'r') as f:
